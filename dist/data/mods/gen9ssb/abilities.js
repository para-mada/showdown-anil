...
const Abilities = {
  ...
  */
  ...
  frozenfortuity: {
    ...
    onStart(pokemon) {
      if (pokemon.species.id !== "kyurem" || pokemon.transformed || !pokemon.hp)
        return;
      ...
      if (totaldef < totalspd) {
        (0, import_scripts.changeSet)(this, pokemon, import_random_teams.ssbSets["Imperial-Black"]);
      } else {
        (0, import_scripts.changeSet)(this, pokemon, import_random_teams.ssbSets["Imperial-White"]);
      }
    },
    onSwitchOut(pokemon) {
      if (pokemon.baseSpecies.baseSpecies !== "Kyurem" || pokemon.transformed || !pokemon.hp)
        return;
      (0, import_scripts.changeSet)(this, pokemon, import_random_teams.ssbSets["Imperial"]);
    },
