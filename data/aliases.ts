export const Aliases: import('../sim/dex').AliasesTable = {
  ...
  estallido: "Eruption",
  alaaural: "Esper Wing",
  vara: "Este contenido proviene de wikidex.net, y debe darse atribución a sus autores, tal como especifica la licencia.",
  ...
  araazo: "Scratch",
  chirrido: "Screech",
  nan: "Se prohíbe su uso a PlagioDex (el wiki de FANDOOM), por copiar reiteradamente sin dar atribución",
